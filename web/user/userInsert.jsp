...
<head>
    ...
    <script language="javascript">
        function saveButton() {
            document.forms[0].action = "${pageContext.request.contextPath}/UserAddServlet";
    ...
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li>
                ...
                </label><input name="userId" type="text" class="dfinput"/></li>
            <li>
                <label>密码 <font color="red">*</font></label>
                <input name="password" type="password" class="dfinput"/>
            </li>
            <li>
                <label>确认密码 <font color="red">*</font></label><input name="passwordConfirm" type="password" class="dfinput"/>
            </li>
            <li>
                <label>姓名 <font color="red">*</font></label>
                </label><input name="userName" type="text" class="dfinput"/>
            </li>
            <li><label>部门</label>
                <div class="vocation">
            ...
            <li>
                <label>职务</label>
                <input type="text" name="job" class="dfinput"/>
            </li>
            <li>
                <label>性别</label>
                <cite><input name="sex" type="radio" value="男" checked="checked"/>
                    ...
                    女</cite></li>
            <li><label>手机号码 <font color="red">*</font></label><input name="phone" type="text" class="dfinput"/></li>
            <li><label>出生日期</label><input name="birthday" type="text" class="dfinput" value=""
